...
| next | `orbit-janitor` — scheduled weekly sweep (inbox age, dupe waste, structure lint, stale waypoints) → one short report dropped in `10-daily/`; the tree nags instead of waiting to be asked | ○ |
